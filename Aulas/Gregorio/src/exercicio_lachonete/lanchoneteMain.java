...
public class lanchoneteMain {
    public static void main(String[] args) {
        ...
        while (menu != 0) {
            ...
            switch (menu) {
                case 1: {
                    System.out.println("Quantos " + Bebida.REFRI.getNome() + "s voce deseja?");
                    quantidade = in.nextInt();
                    System.out.println("Saindo um " + Bebida.REFRI.getNome() + ".");
                    conta += Bebida.REFRI.getPrecoFinal() * quantidade;
                }
                break;
                case 2: {
                    System.out.println("Quantos " + Bebida.AGUA.getNome() + "s voce deseja?");
                    quantidade = in.nextInt();
                    System.out.println("Saindo uma " + Bebida.AGUA.getNome() + ".");
                    conta += Bebida.AGUA.getPrecoFinal() * quantidade;
                }
                break;
                case 3: {
                    System.out.println("Quantos " + Bebida.SUCO.getNome() + "s voce deseja?");
                    quantidade = in.nextInt();
                    System.out.println("Saindo um " + Bebida.SUCO.getNome() + ".");
                    conta += Bebida.SUCO.getPrecoFinal() * quantidade;
                }
                break;
                case 4: {
                    System.out.println("Quantas " + Comida.FRENCHFRIES.getNome() + "s voce deseja?");
                    quantidade = in.nextInt();
                    System.out.println("Saindo uma " + Comida.FRENCHFRIES.getNome() + ".");
                    conta += Comida.FRENCHFRIES.getPrecoFinal() * quantidade;
                }
                break;
                case 5: {
                    System.out.println("Quantos " + Comida.HAMBURGUER.getNome() + "s voce deseja?");
                    quantidade = in.nextInt();
                    System.out.println("Saindo um " + Comida.HAMBURGUER.getNome() + ".");
                    conta += Comida.HAMBURGUER.getPrecoFinal() * quantidade;
                }
                break;
                case 6: {
                    System.out.println("Quantos " + Comida.HOTDOG.getNome() + " voce deseja?");
                    quantidade = in.nextInt();
                    System.out.println("Saindo um " + Comida.HOTDOG.getNome() + ".");
                    conta += Comida.HOTDOG.getPrecoFinal() * quantidade;
                }
                break;
                default:
                    break;
